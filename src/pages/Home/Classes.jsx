...
const Classes = () => {
    ...
    return (
        <div className="w-10/12 mx-auto">
            <h1 className="lg:text-5xl text-3xl font-bold text-center lg:mt-24 lg:mb-12 mt-6">Popular Classes</h1>
            <div className="grid lg:grid-cols-3 grid-cols-2 gap-4 lg:my-8 mt-5">
            {
                classes.map(a => <div key={a._id} className="bg-base-100 shadow-xl rounded-xl lg:mt-12">
